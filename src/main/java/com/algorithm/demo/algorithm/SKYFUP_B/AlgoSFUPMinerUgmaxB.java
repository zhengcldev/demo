...
public class AlgoSFUPMinerUgmaxB
{
    class Pair
    {
        ...
        int item;
        int utility;
        final AlgoSFUPMinerUgmaxB this$0;

        Pair()
        {
            this$0 = AlgoSFUPMinerUgmaxB.this;
            //super();
            item = 0;
            utility = 0;
        }
...
//    }
    ...
    public AlgoResult getResult() {
        ...
        algoResult.setAlgoName("SKYFUP_B");
